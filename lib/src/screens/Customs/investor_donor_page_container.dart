...
Widget InvestorDonorPageContentContainer(
  ...
  String requirement = '';
  if (user is Farmer) {
    requirement = user.requirement; // Corrected from '-' to '='
  }
  ...
  return Container(
    ...
    child: Column(
      ...
      children: [
        ...
        Text(
            '${context.watch<LocalizationService>().translate('requirement')}:',
            style: TextBlack),
        SizedBox(
          width: 10,
        ),
        ...
        const SizedBox(
            height: 5), // Add space between Requirement and Description
