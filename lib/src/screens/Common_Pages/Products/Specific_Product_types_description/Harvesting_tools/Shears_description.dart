...
class ShearsDescription
    extends StatefulWidget {
  @override
  _ShearsDescriptionState createState() =>
      _ShearsDescriptionState();
}

class _ShearsDescriptionState
    extends State<ShearsDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('THTSh'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Harvesting_Tool/shears.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('HTSh'),                              style: TextGrey,
