...
class ScythesDescription
    extends StatefulWidget {
  @override
  _ScythesDescriptionState createState() =>
      _ScythesDescriptionState();
}

class _ScythesDescriptionState
    extends State<ScythesDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('THTSc'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Harvesting_Tool/scythe.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('HTSc'),                              style: TextGrey,
