...
class SicklesDescription
    extends StatefulWidget {
  @override
  _SicklesDescriptionState createState() =>
      _SicklesDescriptionState();
}

class _SicklesDescriptionState
    extends State<SicklesDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('THTSi'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Harvesting_Tool/sickle.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('HTSi'),                              style: TextGrey,
