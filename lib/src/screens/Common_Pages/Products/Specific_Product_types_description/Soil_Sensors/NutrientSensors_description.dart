...
class NutrientsensorsDescription
    extends StatefulWidget {
  @override
  _NutrientsensorsDescriptionState createState() =>
      _NutrientsensorsDescriptionState();
}

class _NutrientsensorsDescriptionState
    extends State<NutrientsensorsDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TSSN'),
                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Soil_sensor/nutrient.png',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('SSN'),                              style: TextGrey,
