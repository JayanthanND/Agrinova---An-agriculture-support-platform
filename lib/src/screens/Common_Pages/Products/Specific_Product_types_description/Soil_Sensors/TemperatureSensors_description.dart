...
class TemperaturesensorsDescription
    extends StatefulWidget {
  @override
  _TemperaturesensorsDescriptionState createState() =>
      _TemperaturesensorsDescriptionState();
}

class _TemperaturesensorsDescriptionState
    extends State<TemperaturesensorsDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TSST'),
                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Soil_sensor/temperature.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('SST'),                              style: TextGrey,
