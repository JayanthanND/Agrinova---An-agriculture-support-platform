...
class PhsensorsDescription
    extends StatefulWidget {
  @override
  _PhsensorsDescriptionState createState() =>
      _PhsensorsDescriptionState();
}

class _PhsensorsDescriptionState
    extends State<PhsensorsDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TSSPH'),
                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Soil_sensor/ph.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('SSPH'),                              style: TextGrey,
