...
class MoisturesensorsDescription
    extends StatefulWidget {
  @override
  _MoisturesensorsDescriptionState createState() =>
      _MoisturesensorsDescriptionState();
}

class _MoisturesensorsDescriptionState
    extends State<MoisturesensorsDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TSSM'),
                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Soil_sensor/moisture.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('SSM'),                              style: TextGrey,
