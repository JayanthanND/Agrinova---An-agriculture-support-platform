...
class ShadehousesDescription
    extends StatefulWidget {
  @override
  _ShadehousesDescriptionState createState() =>
      _ShadehousesDescriptionState();
}

class _ShadehousesDescriptionState
    extends State<ShadehousesDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TGHS'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Green_house/shade.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('GHS'),                              style: TextGrey,
