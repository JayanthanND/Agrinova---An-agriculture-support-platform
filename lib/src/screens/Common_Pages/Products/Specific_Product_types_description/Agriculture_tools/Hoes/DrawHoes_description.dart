...
class DrawhoesDescription
    extends StatefulWidget {
  @override
  _DrawhoesDescriptionState createState() =>
      _DrawhoesDescriptionState();
}

class _DrawhoesDescriptionState
    extends State<DrawhoesDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TATHD'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Agriculture_tool/draw.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('ATHD'),                              style: TextGrey,
