...
class ScufflehoesDescription
    extends StatefulWidget {
  @override
  _ScufflehoesDescriptionState createState() =>
      _ScufflehoesDescriptionState();
}

class _ScufflehoesDescriptionState
    extends State<ScufflehoesDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TATHS'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Agriculture_tool/scuffle.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('ATHS'),                              style: TextGrey,
