...
class WarrenhoesDescription
    extends StatefulWidget {
  @override
  _WarrenhoesDescriptionState createState() =>
      _WarrenhoesDescriptionState();
}

class _WarrenhoesDescriptionState
    extends State<WarrenhoesDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TATHW'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Agriculture_tool/warren.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('ATHW'),                              style: TextGrey,
