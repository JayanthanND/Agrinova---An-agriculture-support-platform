...
class ChiselplowsDescription
    extends StatefulWidget {
  @override
  _ChiselplowsDescriptionState createState() =>
      _ChiselplowsDescriptionState();
}

class _ChiselplowsDescriptionState
    extends State<ChiselplowsDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TATPC'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Agriculture_tool/chiselplow.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('ATPC'),                              style: TextGrey,
                            )
