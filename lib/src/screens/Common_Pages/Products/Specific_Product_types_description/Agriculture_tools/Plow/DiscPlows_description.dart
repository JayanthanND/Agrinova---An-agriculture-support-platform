...
class DiscplowsDescription
    extends StatefulWidget {
  @override
  _DiscplowsDescriptionState createState() =>
      _DiscplowsDescriptionState();
}

class _DiscplowsDescriptionState
    extends State<DiscplowsDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TATPD'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Agriculture_tool/discplow.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('ATPD'),                              style: TextGrey,
