...
class LeafrakesDescription
    extends StatefulWidget {
  @override
  _LeafrakesDescriptionState createState() =>
      _LeafrakesDescriptionState();
}

class _LeafrakesDescriptionState
    extends State<LeafrakesDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TATRLe'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Agriculture_tool/leafrake.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('ATRLe'),                              style: TextGrey,
