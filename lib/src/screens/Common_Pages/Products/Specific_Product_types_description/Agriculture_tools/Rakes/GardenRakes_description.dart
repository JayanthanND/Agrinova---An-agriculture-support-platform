...
class GardenrakesDescription
    extends StatefulWidget {
  @override
  _GardenrakesDescriptionState createState() =>
      _GardenrakesDescriptionState();
}

class _GardenrakesDescriptionState
    extends State<GardenrakesDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TATRG'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Agriculture_tool/gardenrake.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('ATRG'),                              style: TextGrey,
