...
class PruningsawsDescription
    extends StatefulWidget {
  @override
  _PruningsawsDescriptionState createState() =>
      _PruningsawsDescriptionState();
}

class _PruningsawsDescriptionState
    extends State<PruningsawsDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TATPTPSa'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Agriculture_tool/prunningsaw.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('ATPTPSa'),                              style: TextGrey,
