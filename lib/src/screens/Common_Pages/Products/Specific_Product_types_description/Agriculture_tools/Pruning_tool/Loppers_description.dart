...
class LoppersDescription
    extends StatefulWidget {
  @override
  _LoppersDescriptionState createState() =>
      _LoppersDescriptionState();
}

class _LoppersDescriptionState
    extends State<LoppersDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TATPTL'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Agriculture_tool/lopper.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('ATPTL'),                              style: TextGrey,
