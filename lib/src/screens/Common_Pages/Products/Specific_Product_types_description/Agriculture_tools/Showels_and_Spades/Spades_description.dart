...
class SpadesDescription
    extends StatefulWidget {
  @override
  _SpadesDescriptionState createState() =>
      _SpadesDescriptionState();
}

class _SpadesDescriptionState
    extends State<SpadesDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TATSSSp'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Agriculture_tool/spade.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('ATSSSp'),                              style: TextGrey,
