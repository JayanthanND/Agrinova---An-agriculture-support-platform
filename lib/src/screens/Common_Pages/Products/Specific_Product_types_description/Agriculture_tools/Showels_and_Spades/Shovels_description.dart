...
class ShovelsDescription
    extends StatefulWidget {
  @override
  _ShovelsDescriptionState createState() =>
      _ShovelsDescriptionState();
}

class _ShovelsDescriptionState
    extends State<ShovelsDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TATSSSh'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Agriculture_tool/shovel.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('ATSSSh'),                              style: TextGrey,
