...
class BarbedwirefencesDescription
    extends StatefulWidget {
  @override
  _BarbedwirefencesDescriptionState createState() =>
      _BarbedwirefencesDescriptionState();
}

class _BarbedwirefencesDescriptionState
    extends State<BarbedwirefencesDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TFB'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Fencing/barbed.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('FB'),                              style: TextGrey,
