...
class ElectricfencesDescription
    extends StatefulWidget {
  @override
  _ElectricfencesDescriptionState createState() =>
      _ElectricfencesDescriptionState();
}

class _ElectricfencesDescriptionState
    extends State<ElectricfencesDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TFE'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Fencing/electric.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('FE'),                              style: TextGrey,
