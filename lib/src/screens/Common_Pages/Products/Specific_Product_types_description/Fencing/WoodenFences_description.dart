...
class WoodenfencesDescription
    extends StatefulWidget {
  @override
  _WoodenfencesDescriptionState createState() =>
      _WoodenfencesDescriptionState();
}

class _WoodenfencesDescriptionState
    extends State<WoodenfencesDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TFW'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Fencing/wooden.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('FW'),                              style: TextGrey,
