...
class MeshfencingDescription
    extends StatefulWidget {
  @override
  _MeshfencingDescriptionState createState() =>
      _MeshfencingDescriptionState();
}

class _MeshfencingDescriptionState
    extends State<MeshfencingDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TFM'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Fencing/mesh.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('FM'),                              style: TextGrey,
