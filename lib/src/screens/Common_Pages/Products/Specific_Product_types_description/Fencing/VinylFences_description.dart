...
class VinylfencesDescription
    extends StatefulWidget {
  @override
  _VinylfencesDescriptionState createState() =>
      _VinylfencesDescriptionState();
}

class _VinylfencesDescriptionState
    extends State< VinylfencesDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TFV'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Fencing/vinyl.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('FV'),                              style: TextGrey,
