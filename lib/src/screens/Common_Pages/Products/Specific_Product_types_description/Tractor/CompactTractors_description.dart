...
class CompacttractorsDescription
    extends StatefulWidget {
  @override
  _CompacttractorsDescriptionState createState() =>
      _CompacttractorsDescriptionState();
}

class _CompacttractorsDescriptionState
    extends State<CompacttractorsDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TTcom'),style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Tractor/Compacttractor.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('Tcom'),                              style: TextGrey,
