...
class RowcroptractorsDescription
    extends StatefulWidget {
  @override
  _RowcroptractorsDescriptionState createState() =>
      _RowcroptractorsDescriptionState();
}

class _RowcroptractorsDescriptionState
    extends State<RowcroptractorsDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TTrow'),
                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Tractor/Rowcrop.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('Trow'),                              style: TextGrey,
