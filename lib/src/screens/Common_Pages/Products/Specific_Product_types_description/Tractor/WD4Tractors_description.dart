...
class Wd4tractorsDescription
    extends StatefulWidget {
  @override
  _Wd4tractorsDescriptionState createState() =>
      _Wd4tractorsDescriptionState();
}

class _Wd4tractorsDescriptionState
    extends State<Wd4tractorsDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TTwd'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Tractor/4WD.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('Twd'),                              style: TextGrey,
