...
class RowplantersDescription
    extends StatefulWidget {
  @override
  _RowplantersDescriptionState createState() =>
      _RowplantersDescriptionState();
}

class _RowplantersDescriptionState
    extends State<RowplantersDescription> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('TSPR'),                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/Seeders_and_Planters/row.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('SPR'),                              style: TextGrey,
