...
class Murrah extends StatefulWidget {
  const Murrah({super.key});

  @override
  State<Murrah> createState() => _MurrahState();
}

class _MurrahState extends State<Murrah> {
  @override
  void initState() {
    super.initState();
  }
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/livestocks/murrah.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
