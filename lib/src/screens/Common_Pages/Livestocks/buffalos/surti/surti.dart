...
class Surti extends StatefulWidget {
  const Surti({super.key});

  @override
  State<Surti> createState() => _SurtiState();
}

class _SurtiState extends State<Surti> {
  @override
  void initState() {
    super.initState();
  }
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/livestocks/surti.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
