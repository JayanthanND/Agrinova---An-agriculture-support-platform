...
class Jaffrabadi extends StatefulWidget {
  const Jaffrabadi({super.key});

  @override
  State<Jaffrabadi> createState() => _JaffrabadiState();
}

class _JaffrabadiState extends State<Jaffrabadi> {
  @override
  void initState() {
    super.initState();
  }
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/livestocks/jaff.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
