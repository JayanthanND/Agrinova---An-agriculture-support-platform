...
class RedSindhi extends StatefulWidget {
  const RedSindhi({super.key});

  @override
  State<RedSindhi> createState() => _RedSindhiState();
}

class _RedSindhiState extends State<RedSindhi> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('re'),
                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/livestocks/red.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('red'),
                              style: TextGrey,
                            )
