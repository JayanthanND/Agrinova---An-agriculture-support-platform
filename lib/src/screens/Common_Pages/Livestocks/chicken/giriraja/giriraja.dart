...
class Giriraja extends StatefulWidget {
  const Giriraja({super.key});

  @override
  State<Giriraja> createState() => _GirirajaState();
}

class _GirirajaState extends State<Giriraja> {
  @override
  void initState() {
    super.initState();
  }
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/livestocks/giriraja.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
