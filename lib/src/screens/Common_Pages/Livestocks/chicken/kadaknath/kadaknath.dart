...
class Kadaknath extends StatefulWidget {
  const Kadaknath({super.key});

  @override
  State<Kadaknath> createState() => _KadaknathState();
}

class _KadaknathState extends State<Kadaknath> {
  @override
  void initState() {
    super.initState();
  }
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/livestocks/kadaknath.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
