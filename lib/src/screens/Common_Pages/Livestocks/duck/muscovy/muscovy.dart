...
class Muscovy extends StatefulWidget {
  const Muscovy({super.key});

  @override
  State<Muscovy> createState() => _MuscovyState();
}

class _MuscovyState extends State<Muscovy> {
  @override
  void initState() {
    super.initState();
  }
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/livestocks/muscovy.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
