...
class Deccani extends StatefulWidget {
  const Deccani({super.key});

  @override
  State<Deccani> createState() => _DeccaniState();
}

class _DeccaniState extends State<Deccani> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('tdec'),
                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/livestocks/deccani.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('dec'),
                              style: TextGrey,
                            )
