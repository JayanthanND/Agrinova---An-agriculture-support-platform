...
class Angora extends StatefulWidget {
  const Angora({super.key});

  @override
  State<Angora> createState() => _AngoraState();
}

class _AngoraState extends State<Angora> {
  @override
  void initState() {
    super.initState();
  }
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/livestocks/angora.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
