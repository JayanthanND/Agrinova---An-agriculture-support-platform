...
class Soviet extends StatefulWidget {
  const Soviet({super.key});

  @override
  State<Soviet> createState() => _SovietState();
}

class _SovietState extends State<Soviet> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('tsov'),
                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/livestocks/soviet.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('sov'),
                              style: TextGrey,
                            )
