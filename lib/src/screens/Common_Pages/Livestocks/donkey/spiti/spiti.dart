...
class Spiti extends StatefulWidget {
  const Spiti({super.key});

  @override
  State<Spiti> createState() => _SpitiState();
}

class _SpitiState extends State<Spiti> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('spi'),
                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/livestocks/spititi.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('spit'),
                              style: TextGrey,
                            )
