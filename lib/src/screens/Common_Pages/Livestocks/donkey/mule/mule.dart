...
class Mule extends StatefulWidget {
  const Mule({super.key});

  @override
  State<Mule> createState() => _MuleState();
}

class _MuleState extends State<Mule> {
  @override
  void initState() {
    super.initState();
  }
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/livestocks/mule.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
