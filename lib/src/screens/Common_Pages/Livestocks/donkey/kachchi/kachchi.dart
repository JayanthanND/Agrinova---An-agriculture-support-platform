...
class Kachchi extends StatefulWidget {
  const Kachchi({super.key});

  @override
  State<Kachchi> createState() => _KachchiState();
}

class _KachchiState extends State<Kachchi> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('kac'),
                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/livestocks/kachichi.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('kach'),
                              style: TextGrey,
                            )
