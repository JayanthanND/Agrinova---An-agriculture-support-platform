...
class Pashmina extends StatefulWidget {
  const Pashmina({super.key});

  @override
  State<Pashmina> createState() => _PashminaState();
}

class _PashminaState extends State<Pashmina> {
  @override
  void initState() {
    super.initState();
  }
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/livestocks/pash.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
