...
class Beetal extends StatefulWidget {
  const Beetal({super.key});

  @override
  State<Beetal> createState() => _BeetalState();
}

class _BeetalState extends State<Beetal> {
  @override
  void initState() {
    super.initState();
  }
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/livestocks/beetal.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
