...
class Saheen extends StatefulWidget {
  const Saheen({super.key});

  @override
  State<Saheen> createState() => _SaheenState();
}

class _SaheenState extends State<Saheen> {
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Text(
                                context.watch<LocalizationService>().translate('san'),
                                style: NormalTextBlack,
                              ),
                            ),
                            Center(
                              child: Image.asset(
                                'assets/images/livestocks/saneen.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
                            ...
                            Text(
                              context.watch<LocalizationService>().translate('sane'),
                              style: TextGrey,
                            )
