...
class _ChatScreenState extends State<ChatScreen> with WidgetsBindingObserver {
  ...
  Future<void> _sendMessage(String message,
    ...
    Map<String, dynamic> messageData = {
      ...
      'seen': false,
      'isRead': false,
      'repliedMessage': _replyMessage ?? '',
      'repliedMessageSender':
          _isReplyingToMe ? widget.senderId : widget.receiverId,
    };
          ...
          child: Wrap(
            children: <Widget>[
              ListTile(
                ...
                title: Text(
                    context.watch<LocalizationService>().translate('gallery')),
                onTap: () {
              ...
              ListTile(
                ...
                title: Text(
                    context.watch<LocalizationService>().translate('document')),
                onTap: () {
                  Navigator.pop(context); // Close the bottom sheet
  ...
  String _getFormattedDate(DateTime dateTime) {
    ...
    if (dateTime.isAfter(today)) {
      return context.watch<LocalizationService>().translate('today');
    } else if (dateTime.isAfter(yesterday)) {
      return context.watch<LocalizationService>().translate('yesterday');
    } else {
                      ...
                      child: Row(
                        children: [
                          Container(
                            width: 4,
                            height: 40,
                            color: _isReplyingToMe ? Colors.blue : Colors.green,
                          ...
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  context.watch<LocalizationService>().translate(
                                      '${context.watch<LocalizationService>().translate('replyingTo')} ${_isReplyingToMe ? context.watch<LocalizationService>().translate("yourself") : widget.receiverName}'),
                                  style: TextStyle(
                                    fontWeight: FontWeight.bold,
