...
class Shatavari extends StatefulWidget {
  const Shatavari({super.key});

  @override
  State<Shatavari> createState() => _ShatavariState();
}

class _ShatavariState extends State<Shatavari> {
  @override
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/medicine plants/shatavari.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
