...
class Giloy extends StatefulWidget {
  const Giloy({super.key});

  @override
  State<Giloy> createState() => _GiloyState();
}

class _GiloyState extends State<Giloy> {
  @override
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/medicine plants/giloy.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
