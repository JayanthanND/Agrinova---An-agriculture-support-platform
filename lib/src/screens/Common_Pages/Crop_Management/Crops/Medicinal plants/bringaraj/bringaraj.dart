...
class Bringaraj extends StatefulWidget {
  const Bringaraj({super.key});

  @override
  State<Bringaraj> createState() => _BringarajState();
}

class _BringarajState extends State<Bringaraj> {
  @override
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/medicine plants/bringaraj.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
