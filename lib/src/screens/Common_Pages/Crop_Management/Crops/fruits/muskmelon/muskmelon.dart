...
class Muskmelon extends StatefulWidget {
  const Muskmelon({super.key});

  @override
  State<Muskmelon> createState() => _MuskmelonState();
}

class _MuskmelonState extends State<Muskmelon> {
  @override
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/fruits/muskmelon.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
