...
class Jackfruit extends StatefulWidget {
  const Jackfruit({super.key});

  @override
  State<Jackfruit> createState() => _JackfruitState();
}

class _JackfruitState extends State<Jackfruit> {
  @override
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/fruits/jackfruit.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
