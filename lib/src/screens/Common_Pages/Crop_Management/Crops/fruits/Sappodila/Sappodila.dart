...
class Sappodila extends StatefulWidget {
  const Sappodila({super.key});

  @override
  State<Sappodila> createState() => _SappodilaState();
}

class _SappodilaState extends State<Sappodila> {
  @override
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/fruits/sappodila.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
