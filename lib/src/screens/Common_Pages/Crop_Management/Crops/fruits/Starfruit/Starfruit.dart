...
class Starfruit extends StatefulWidget {
  const Starfruit({super.key});

  @override
  State<Starfruit> createState() => _StarfruitState();
}

class _StarfruitState extends State<Starfruit> {
  @override
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/fruits/starfruit.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
