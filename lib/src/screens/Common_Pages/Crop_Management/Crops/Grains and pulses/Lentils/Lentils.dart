...
class Lentils extends StatefulWidget {
  const Lentils({super.key});

  @override
  State<Lentils> createState() => _LentilsState();
}

class _LentilsState extends State<Lentils> {
  @override
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/grains and pulses/lentils.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
