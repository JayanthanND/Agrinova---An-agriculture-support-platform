...
class Oats extends StatefulWidget {
  const Oats({super.key});

  @override
  State<Oats> createState() => _OatsState();
}

class _OatsState extends State<Oats> {
  @override
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/grains and pulses/oats.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
