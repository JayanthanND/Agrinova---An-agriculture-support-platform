...
class Cottonseed extends StatefulWidget {
  const Cottonseed({super.key});

  @override
  State<Cottonseed> createState() => _CottonseedState();
}

class _CottonseedState extends State<Cottonseed> {
  @override
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/oilseeds/cottonseed.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
