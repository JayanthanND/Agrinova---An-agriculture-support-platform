...
class Gingelly extends StatefulWidget {
  const Gingelly({super.key});

  @override
  State<Gingelly> createState() => _GingellyState();
}

class _GingellyState extends State<Gingelly> {
  @override
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/oilseeds/gingelly.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
