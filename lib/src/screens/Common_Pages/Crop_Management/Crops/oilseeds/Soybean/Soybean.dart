...
class Soybean extends StatefulWidget {
  const Soybean({super.key});

  @override
  State<Soybean> createState() => _SoybeanState();
}

class _SoybeanState extends State<Soybean> {
  @override
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/oilseeds/soybean.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
