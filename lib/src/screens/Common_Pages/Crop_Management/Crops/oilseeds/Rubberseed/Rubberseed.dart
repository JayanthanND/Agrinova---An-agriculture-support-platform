...
class Rubberseed extends StatefulWidget {
  const Rubberseed({super.key});

  @override
  State<Rubberseed> createState() => _RubberseedState();
}

class _RubberseedState extends State<Rubberseed> {
  @override
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/oilseeds/rubberseed.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
