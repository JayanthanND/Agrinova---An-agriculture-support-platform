...
class Raddish extends StatefulWidget {
  const Raddish({super.key});

  @override
  State<Raddish> createState() => _RaddishState();
}

class _RaddishState extends State<Raddish> {
  @override
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/vegetables/raddish.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
