...
class BottleGuard extends StatefulWidget {
  const BottleGuard({super.key});

  @override
  State<BottleGuard> createState() => _BottleGuardState();
}

class _BottleGuardState extends State<BottleGuard> {
  @override
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/vegetables/bottle.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
