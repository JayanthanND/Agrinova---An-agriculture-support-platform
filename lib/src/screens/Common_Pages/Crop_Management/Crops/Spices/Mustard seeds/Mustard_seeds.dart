...
class MustardSeeds extends StatefulWidget {
  const MustardSeeds({super.key});

  @override
  State<MustardSeeds> createState() => _MustardSeedsState();
}

class _MustardSeedsState extends State<MustardSeeds> {
  @override
                      ...
                      MainContainer1(
                        child: Column(
                          ...
                          children: [
                            ...
                            Center(
                              child: Image.asset(
                                'assets/images/spices/mustard seeds.jpg',
                                height: 300,
                                width: 300,
                              ),
                            ),
