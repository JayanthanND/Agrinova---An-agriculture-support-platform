...
import 'package:project_agrinova/src/screens/Investor_HomePage/follow_request_page_investor.dart';
...
class InvestorHomepage extends StatefulWidget {
  ...
  const InvestorHomepage({super.key, required this.userData});
  @override
...
class _InvestorHomepageState extends State<InvestorHomepage> {
  ...
  void initState() {
    ...
    fetchFarmerswithInvestment().then((users) {
      setState(() {
  ...
  Future<List<customUser.User>> fetchFarmerswithInvestment() async {
    ...
    try {
      ...
      allUsers.addAll(farmers.where((farmer) {
        return (farmer as customUser.Farmer).request == 'Investment';
      }).toList());
                          ...
                          onTap: () {
                            if (userData != null) {
                              Navigator.of(context).push(SlideRightRoute(
                                page:
                                    InvestorProfileScreen(userData: userData!),
                              ));
                            } else {
