...
import '../Donor_HomePage/farmer_details_screen.dart';

class FollowersFollowingInvestorScreen extends StatefulWidget {
  final String currentUserId;

  const FollowersFollowingInvestorScreen(
      {super.key, required this.currentUserId});

  @override
  _FollowersFollowingInvestorScreenState createState() =>
      _FollowersFollowingInvestorScreenState();
}

class _FollowersFollowingInvestorScreenState
    extends State<FollowersFollowingInvestorScreen> {
  ...
  Future<void> _sendFollowRequest(String followerId, String collection) async {
    try {
      ...
      await FirebaseFirestore.instance
          ...
          .set(
        {
          'followRequests': FieldValue.arrayUnion([widget.currentUserId]),
        },
      ...
      await FirebaseFirestore.instance
          .collection('investors') // Always update the 'farmers' collection
          .doc(widget.currentUserId)
          .set(
        {
            ...
            return FutureBuilder<DocumentSnapshot>(
              ...
              builder: (context, userSnapshot) {
                ...
                bool isFollower = followingList.any((followers) =>
                    ...
                    followers['collection'] == 'investors');
                return ListTile(
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => FarmerDetailsScreen(
                            ...
                            currentUserCollection: 'investors',
                          ),
                        ),
                      );
                    },
    ...
    return StreamBuilder<DocumentSnapshot>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData || snapshot.data == null) {
          return Center(
              child: Text(
            context.watch<LocalizationService>().translate('no_following'),
            style: SmallTextGrey,
          ));
        }
