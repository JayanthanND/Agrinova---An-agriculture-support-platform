...
import 'package:project_agrinova/src/screens/Investor_HomePage/investor_message_screen.dart';
...
import 'followers_and_following_page_investor.dart';
import 'investor_editProfile_screen.dart';

class InvestorProfileScreen extends StatefulWidget {
  final Map<String, dynamic> userData;

  const InvestorProfileScreen({super.key, required this.userData});
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  final updatedData = await Navigator.of(context).push(
                    SlideLeftRoute(
                      page:
                          InvestorEditprofileScreen(userData: currentUserData),
                    ),
                  );
          ...
          ProfileWidget(
            ...
            onPress: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => InvestorMessageScreen(),
                  ));
            },
          ...
          ProfileWidget(
            ...
            onPress: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        SettingsScreen(collectionName: "investors"),
                  ));
            },
            textStyle: SmallTextGrey,
          ),
          ...
          ProfileWidget(
            ...
            onPress: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => FollowersFollowingInvestorScreen(
