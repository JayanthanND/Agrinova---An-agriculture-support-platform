...
class InvestorMessageScreen extends StatefulWidget {
  @override
  _InvestorMessageScreenState createState() => _InvestorMessageScreenState();
}

class _InvestorMessageScreenState extends State<InvestorMessageScreen> {
