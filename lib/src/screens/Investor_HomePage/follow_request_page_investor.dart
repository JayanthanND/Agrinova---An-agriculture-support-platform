...
class FollowRequestsPageInvestor extends StatefulWidget {
  final String currentUserId;

  const FollowRequestsPageInvestor({super.key, required this.currentUserId});

  @override
  _FollowRequestsPageInvestorState createState() =>
      _FollowRequestsPageInvestorState();
}

class _FollowRequestsPageInvestorState
    extends State<FollowRequestsPageInvestor> {
  ...
  Future<void> initializeUserId() async {
    try {
      ...
      if (user != null) {
        ...
        setState(() {}); // Trigger rebuild after user is initialized
                        ...
                        MaterialPageRoute(
                          builder: (context) => FarmerDetailsScreen(
                            ...
                            currentUserCollection:
                                'investors', // Replace with your collection
                          ),
                        ),
                      );
                    },
    ...
    try {
      await FirebaseFirestore.instance
        ...
        'followers': FieldValue.arrayUnion([
          {'userId': requestUserId, 'collection': 'farmers'}
        ]),
      ...
      await FirebaseFirestore.instance
        ...
        'following': FieldValue.arrayUnion([
          {'userId': currentUserId, 'collection': 'investors'}
        ]),
