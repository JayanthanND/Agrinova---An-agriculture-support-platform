...
import 'package:project_agrinova/src/screens/Retailer_HomePage/followers_and_following_page_retailer.dart';
import 'package:project_agrinova/src/screens/Retailer_HomePage/retailer_message_screen.dart';
...
import 'retailer_editproflie_screen.dart';

class RetailerProfileScreen extends StatefulWidget {
  final Map<String, dynamic> userData;

  const RetailerProfileScreen({super.key, required this.userData});

  @override
  _RetailerProfileScreenState createState() => _RetailerProfileScreenState();
}
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  final updatedData = await Navigator.of(context).push(
                    SlideLeftRoute(
                      page:
                          RetailerEditproflieScreen(userData: currentUserData),
                    ),
                  );
          ...
          ProfileWidget(
            ...
            onPress: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => RetailerMessageScreen(),
                  ));
            },
          ...
          ProfileWidget(
            ...
            onPress: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        SettingsScreen(collectionName: "retailers"),
                  ));
            },
            textStyle: SmallTextGrey,
          ),
          ...
          ProfileWidget(
            ...
            onPress: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => FollowersFollowingRetailerScreen(
