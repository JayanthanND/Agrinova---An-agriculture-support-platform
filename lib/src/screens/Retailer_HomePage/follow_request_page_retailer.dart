...
class FollowRequestsPageRetailer extends StatefulWidget {
  final String currentUserId;

  const FollowRequestsPageRetailer({super.key, required this.currentUserId});

  @override
  _FollowRequestsPageRetailerState createState() =>
      _FollowRequestsPageRetailerState();
}

class _FollowRequestsPageRetailerState
    extends State<FollowRequestsPageRetailer> {
                        ...
                        MaterialPageRoute(
                          builder: (context) => FarmerDetailsScreen(
                            ...
                            currentUserCollection:
                                'retailers', // Replace with your collection
                          ),
                        ),
                      );
                    },
    ...
    try {
      ...
      await FirebaseFirestore.instance
        ...
        'following': FieldValue.arrayUnion([
          {'userId': currentUserId, 'collection': 'retailers'}
        ]),
