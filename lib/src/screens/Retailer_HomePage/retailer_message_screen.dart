...
class RetailerMessageScreen extends StatefulWidget {
  @override
  _RetailerMessageScreenState createState() => _RetailerMessageScreenState();
}

class _RetailerMessageScreenState extends State<RetailerMessageScreen> {
