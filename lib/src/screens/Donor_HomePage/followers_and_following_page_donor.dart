...
class FollowersFollowingDonorScreen extends StatefulWidget {
  final String currentUserId;

  const FollowersFollowingDonorScreen({super.key, required this.currentUserId});

  @override
  _FollowersFollowingDonorScreenState createState() =>
      _FollowersFollowingDonorScreenState();
}

class _FollowersFollowingDonorScreenState
    extends State<FollowersFollowingDonorScreen> {
  ...
  Future<void> _sendFollowRequest(String followerId, String collection) async {
    try {
      ...
      await FirebaseFirestore.instance
          .collection('donors') // Always update the 'farmers' collection
          .doc(widget.currentUserId)
          .set(
        {
                      ...
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) => FarmerDetailsScreen(
                            ...
                            }, // Correct follower data
                            currentUserId: widget.currentUserId,
                            currentUserCollection: 'donors',
                          ),
                        ),
                      );
                    },
