...
import 'package:project_agrinova/src/screens/Common_Pages/About/about_screen.dart';
import 'package:project_agrinova/src/screens/Donor_HomePage/followers_and_following_page_donor.dart';
import 'package:project_agrinova/src/screens/Common_Pages/Settings/settings_screen.dart';
...
import 'donor_editProfile_screen.dart';
import 'donor_message_screen.dart';
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  final updatedData = await Navigator.of(context).push(
                    SlideLeftRoute(
                      page: DonorEditprofileScreen(userData: currentUserData),
                    ),
                  );
          ...
          ProfileWidget(
            ...
            onPress: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => DonorMessageScreen(),
                  ));
            },
          ...
          ProfileWidget(
            ...
            onPress: () {
              Navigator.push(
                  ...
                  MaterialPageRoute(
                    builder: (context) =>
                        SettingsScreen(collectionName: "donors"),
                  ));
            },
            textStyle: SmallTextGrey,
          ),
          ...
          ProfileWidget(
            ...
            onPress: () {
              Navigator.push(
                  context,
                  MaterialPageRoute(
                    builder: (context) => FollowersFollowingDonorScreen(
