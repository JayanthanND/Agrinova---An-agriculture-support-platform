...
class FollowRequestsPageDonor extends StatefulWidget {
  final String currentUserId;

  const FollowRequestsPageDonor({super.key, required this.currentUserId});

  @override
  _FollowRequestsPageDonorState createState() =>
      _FollowRequestsPageDonorState();
}

class _FollowRequestsPageDonorState extends State<FollowRequestsPageDonor> {
                        ...
                        MaterialPageRoute(
                          builder: (context) => FarmerDetailsScreen(
                            ...
                            currentUserCollection:
                                'donors', // Replace with your collection
                          ),
                        ),
                      );
                    },
    ...
    try {
      ...
      await FirebaseFirestore.instance
        ...
        'following': FieldValue.arrayUnion([
          {'userId': currentUserId, 'collection': 'donors'}
        ]),
