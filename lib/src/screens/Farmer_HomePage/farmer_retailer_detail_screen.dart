...
class _RetailerDetailsScreenState extends State<RetailerDetailsScreen> {
  ...
  // Method to handle sending a follow request
  @override
  void initState() {
    super.initState();
    initializeUserId();
  ...
  Future<void> _checkRequestStatus() async {
    try {
      ...
      DocumentSnapshot userSnapshot = await FirebaseFirestore.instance
          .collection('retailers') // Use dynamic target collection
              ...
              child: Column(
                ...
                children: [
                  ...
                  DetailField(
                    ...
                    value: widget.user['cropReqd'],
                  ),
                  const SizedBox(height: 10),
                  DetailField(
                    label: context
                        .watch<LocalizationService>()
                        .translate('descreption'),
