...
class FollowersFollowingScreen extends StatefulWidget {
  ...
  const FollowersFollowingScreen({super.key, required this.currentUserId});
...
class _FollowersFollowingScreenState extends State<FollowersFollowingScreen> {
      ...
      if (user != null) {
        ...
        if (userDoc.exists) {
          ...
          setState(() {
            ...
            print("Farmer's need: $farmerNeed");
          });
        }
  ...
  Future<void> _sendFollowRequest(String followerId, String collection) async {
    try {
      ...
      await FirebaseFirestore.instance
          .collection('farmers') // Always update the 'farmers' collection
          .doc(widget.currentUserId)
          .set(
        {
